...
//            simulationWindow.setModal(true);
    ...
    private void calculatePathsForAllMines(){
    ...
    private void calculatePathForMine(Mine mine){
        if(mine.getInfrastructures() == null || mine.getInfrastructures().isEmpty()){
            return;
        }
